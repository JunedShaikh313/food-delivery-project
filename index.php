...
<div id="result" style="position:fixed;top:90; right:400;z-index: 3000;width:350px;background:white;"></div>
<div id="resulthotel" style=" margin:0px auto; position:fixed; top:90px;right:650px; background:white;  z-index: 3000;"></div>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="Los Angeles" class="d-block w-100" style="height:100%">
    ...
    <div class="carousel-item">
      <img src="img/coffee_cup_saucer_grains_foam_73571_1920x1080.jpg" alt="Chicago" class="d-block w-100" style="height:100%">
      <div class="carousel-caption">
        <h3>Chicago</h3>
    ...
    <div class="carousel-item">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="New York" class="d-block w-100" style="height:100%">
      <div class="carousel-caption">
        <h3>New York</h3>
...
<div class="container-fluid">
  <div class="row">
   ...
   <div class="col-sm-6">
	   <div class="fluid rounded" style="border:solid 1px #F0F0F0;">
   <?php
							...
							tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
	                             while($res=mysqli_fetch_assoc($query))
		                            ...
		                            <!--hotel logo-->  <div class="col-sm-2"><img src="<?php echo $hotel_logo; ?>" class="rounded-circle" height="50px" width="50px" alt="Cinque Terre"></div>
		                                               <div class="col-sm-5">
		                            <!--hotelname-->        <a href="search.php?vendor_id=<?php echo $res['fldvendor_id']; ?>"><span style="font-family: 'Miriam Libre', sans-serif; font-size:28px;color:#CB202D;">
		 <?php echo $res['fld_name']; ?></span></a>
                                                       </div>
